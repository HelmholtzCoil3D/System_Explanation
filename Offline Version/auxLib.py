'''
This script contains all the functions and classes used in the project.
...
# https://github.com/pyvisa/pyvisa/issues/306 - RTB code 
def RTB_measurement(RTB):
...
def RTB_setup(RTB):
    ...
    RTB.write('CHAN1:RANG 0.5')  # Horizontal range 5V (0.5V/div)
